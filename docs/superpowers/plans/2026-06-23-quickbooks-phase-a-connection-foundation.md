...
- **Spec reference:** `docs/superpowers/specs/2026-06-23-quickbooks-accounting-integration-design.md` — read the Data model, OAuth & token model, and Multi-tenancy/RLS sections before starting.
