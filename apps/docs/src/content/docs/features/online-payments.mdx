...
description: Let your customers pay invoices by card online, settled directly into your own Stripe account -- BL4CK takes no fee and never touches the funds.
sidebar:
...
Online Payments lets your customers pay their invoices by card through a secure checkout, with the money settling directly into **your own Stripe account**. BL4CK stays out of the middle: there's no platform fee, no funds pass through us, and your business remains the merchant of record on your customer's statement.

## How It Works

You connect your Stripe account to BL4CK once. After that, any issued invoice can carry a shareable **payment link**, and customers can also pay from the [Customer Portal](/features/portal/). Payments collected online are recorded against the invoice automatically.

- **You are the merchant of record.** Your customer's card statement shows your business, and you handle any chargebacks -- not BL4CK.
- **No platform fee.** You receive the full payment, less Stripe's own processing fees. BL4CK adds nothing.
- **Card payments, hosted by Stripe.** Customers complete checkout on Stripe's secure hosted page; card details never touch BL4CK.
...
3. Authorize BL4CK on Stripe's screen and you're returned to billing settings, now showing as connected.
</Steps>
...
Refunds are **reflect-only**: you issue a refund from your own Stripe dashboard, and BL4CK stays in sync automatically -- the refunded amount is reflected back on the invoice. There's no separate refund step inside BL4CK.
