...
With Root Cause Analysis enabled, an incident offers an on-demand **Explain incident** button. BL4CK gathers evidence from around the incident's time window and produces:
...
- **Evidence gaps** — what BL4CK looked for but couldn't find
