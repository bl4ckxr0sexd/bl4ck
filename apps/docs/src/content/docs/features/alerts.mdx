...
Select multiple alerts using the checkboxes, then choose **Acknowledge Selected**, **Resolve Selected**, or **Suppress Selected** from the bulk action menu. Bulk suppressing prompts for the same duration options as a single alert, including **Forever**. You can act on up to 100 alerts at once.
