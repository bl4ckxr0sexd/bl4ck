...
BL4CK includes 15 CIS checks aligned with the **CIS Apple macOS Benchmark Level 1** sharing and security controls. These checks evaluate whether common macOS sharing services and firewall settings are configured securely. They run automatically as part of any macOS baseline scan.
