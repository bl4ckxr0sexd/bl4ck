...
SLA Management lets you define recovery objectives for your backup-protected devices and automatically alerts you when those objectives aren't met. Set RPO (how much data loss you can tolerate) and RTO (how quickly you need to recover) targets, then let BL4CK monitor compliance.
...
BL4CK continuously monitors backup activity against your SLA policies:
