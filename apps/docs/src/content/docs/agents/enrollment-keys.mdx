...
description: Create, scope, rotate, and manage enrollment keys for onboarding agents into BL4CK RMM.
sidebar:
  order: 6
...
Enrollment key management respects the BL4CK multi-tenant hierarchy:
