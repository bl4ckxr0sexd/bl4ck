...
description: Compile the BL4CK agent from source for any platform.
sidebar:
  order: 3
...
This runs the agent directly without installing it as a service. Useful for testing against a local BL4CK server.
